...
begin
 ...
 // edtProduto.Clear;
 // edtProduto.SetFocus;
 // TPageMensagens.New(Self).Mensagem('O caixa deve estar aberto!', INFORMACAO)
...
begin
 ...
 case Key of
  ...
  VK_F4:
   begin
    TPageFechamentoCaixa.New(Self).Embed(pnlMaster)
  ...
  VK_F2:
   begin
    TPageAbrirCaixa.New(Self).Embed(pnlMaster).Informacoes(FCaixa).Click(
...
begin
 loperador := 'Caixa: ' + FCaixa.Items['nomecaixa'] + ' | Operador: ' +
   FCaixa.Items['nomeoperador'] + ' | Turno: ' + FCaixa.Items['nometurno'];
